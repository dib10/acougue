...
<head>
    ...
    <link rel="stylesheet" href="../../style/css_usuario/css-bovino.css">
    <link rel="icon" href="../../img/logo.png">
    <title>Açougu-E - Bovinos</title>
</head>
<body>
    <?php include_once "nav_usuario.php"; ?>
    <main>
        <div class="container">
            <h1 id="titulo_cortes">Bovinos</h1>
            <ul class="container produtos">
                ...
                <li class="container produtos cartao">
                    ...
                    <img src="../../img/corte<?= $aux ?>_bovinos.png" alt="Cortes frango"/>
