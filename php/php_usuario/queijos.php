...
<head>
    ...
    <link rel="stylesheet" href="../../style/css_usuario/css-queijos.css">
    <link rel="icon" href="../../img/logo.png">
    <title>Açougu-E - Queijos</title>
</head>
<body>
    <?php include_once "nav_usuario.php"; ?>
    <main>
        <div class="container">
            <h1 id="titulo_cortes">Queijos</h1>
            <ul class="container produtos">
                ...
                <li class="container produtos cartao">
                    ...
                    <img src="../../img/corte<?= $aux ?>_queijos.png" alt="Cortes frango"/>
