...
<head>
    ...
    <link rel="stylesheet" href="../../style/css_usuario/css-aves.css">
    <link rel="icon" href="../../img/logo.png">
    <title>Açougu-E - Aves</title>
</head>
<body>
    <?php include_once "nav_usuario.php"; ?>
    <main>
        <div class="container">
            <h1 id="titulo_cortes">Aves</h1>
            <ul class="container produtos">
                <?php
                    //Consulta ao banco de dados para exibir os produtos.
                ...
                <li class="container produtos cartao">
                    ...
                    <img src="../../img/corte<?= $aux ?>_aves.png" alt="Cortes frango"/>
